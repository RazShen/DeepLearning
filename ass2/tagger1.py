...
class ModelBuilder(object):
    ...
    def train_validate_test(self):
        """
        This method trains the a_pos_m and validate it, and then test the a_pos_m & print the results
        into a graph.
        :return:
        """
    ...
    def test(self):
        """
        This method goes through the data, get the a_pos_m output create list of tags, later calls a
